<?php $__env->startSection('title', __('contact.page_title') . ' - Cahaya Interior Sejahtera'); ?>
<?php $__env->startSection('meta_description', 'Konsultasikan kebutuhan interior rumah, kantor, atau ruang komersial Anda bersama tim Cahaya Interior Sejahtera. Layanan desain interior premium di Bogor dan Jakarta.'); ?>
            ...
            <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                <div class="max-w-2xl">
                    ...
                    <p class="text-secondary text-body-md max-w-xl leading-relaxed">
                        <?php echo e(__('contact.page_subtitle')); ?>

                    </p>
                </div>
                <div class="shrink-0 hidden md:block">
                    <div class="flex items-center gap-3 text-secondary">
                        <span class="font-label-md text-label-md uppercase tracking-widest"><?php echo e(__('contact.office_address')); ?></span>
                ...
                <div class="lg:col-span-7">
                    <form onsubmit="event.preventDefault(); submitToWhatsApp(this)" class="flex flex-col gap-6 md:gap-8">
                        <div class="flex flex-col">
                            <label for="full_name" class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-2"><?php echo e(__('contact.full_name')); ?></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                            <div class="flex flex-col">
                                <label for="email" class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-2"><?php echo e(__('contact.email')); ?></label>
                            ...
                            <div class="flex flex-col">
                                <label for="phone" class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-2"><?php echo e(__('contact.phone')); ?></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                            <div class="flex flex-col">
                                <label for="project_type" class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-2"><?php echo e(__('contact.project_type')); ?></label>
                                <div class="relative">
                            ...
                            <div class="flex flex-col">
                                <label for="project_location" class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-2"><?php echo e(__('contact.project_location')); ?></label>
                        ...
                        <div class="flex flex-col">
                            <label for="message" class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-2"><?php echo e(__('contact.message')); ?></label>
                        ...
                        <div class="pt-2">
                            <button type="submit"
                                ...
                                <?php echo e(__('contact.request_consultation')); ?>
                        ...
                        <div class="bg-surface-container border-l-4 border-premium-brass px-6 py-4 text-primary font-body-md text-body-md hidden" id="success-message">
                            <?php echo e(__('contact.success_message')); ?>
                    ...
                    <div class="bg-surface-container-lowest border border-outline-variant/40 rounded-card p-6 md:p-8 shadow-level-1">
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <a href="https://www.google.com/maps?q=Jl+Griya+Alam+Sentosa+No+101+Dusun+Pasir+Angin+Cileungsi+Bogor+Jawa+Barat" target="_blank" rel="noopener noreferrer" class="flex items-start gap-4 group">
                                ...
                                <div>
                                    <p class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-0.5"><?php echo e(__('contact.office_address')); ?></p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="font-label-lg text-label-lg text-secondary uppercase tracking-widest mb-0.5"><?php echo e(__('contact.business_hours_label')); ?></p>
                                    <ul class="font-body-md text-body-md text-primary flex flex-col gap-1.5">
                                        <li class="flex justify-between gap-6">
                                            ...
                                            <span><?php echo e(__('contact.hours_weekday')); ?></span>
                                        </li>
                                        <li class="flex justify-between gap-6">
                                            <span><?php echo e(__('contact.saturday')); ?></span>
                                            <span class="text-secondary"><?php echo e(__('contact.hours_saturday')); ?></span>
                                        </li>
                                        <li class="flex justify-between gap-6">
                                            <span><?php echo e(__('contact.sunday')); ?></span>
                                            <span class="text-secondary"><?php echo e(__('contact.by_appointment')); ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-outline-variant/30">
                            <a href="https://wa.me/6285776755884" target="_blank" rel="noopener noreferrer"
                                ...
                                <?php echo e(__('contact.chat_via_whatsapp')); ?>
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center items-stretch sm:items-center">
                <a href="https://wa.me/6285776755884" target="_blank" rel="noopener noreferrer"
                    ...
                    <?php echo e(__('contact.cta_primary')); ?>

                </a>
                <a href="<?php echo e(route('projects', ['locale' => app()->getLocale()])); ?>"
                    ...
                    <?php echo e(__('contact.cta_secondary')); ?>
