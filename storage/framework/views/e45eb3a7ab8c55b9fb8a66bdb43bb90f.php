<footer class="w-full bg-surface-container-low border-t border-outline-variant/30">
    <div class="max-w-[1280px] mx-auto px-5 sm:px-8 md:px-16 py-14 md:py-20">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
            ...
            <div>
                <h4 class="font-label-lg text-label-lg text-primary uppercase tracking-[0.15em]"><?php echo e(__('footer.navigation')); ?></h4>
                <div class="w-8 h-0.5 bg-premium-brass mt-1.5 mb-5"></div>
                <ul class="flex flex-col gap-3">
                    <li><a href="<?php echo e(route('home')); ?>" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('nav.home')); ?></a></li>
                    <li><a href="<?php echo e(route('about')); ?>" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('nav.about')); ?></a></li>
                    <li><a href="<?php echo e(route('projects')); ?>" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('nav.projects')); ?></a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('nav.contact')); ?></a></li>
                </ul>
            </div>

            <div>
                <h4 class="font-label-lg text-label-lg text-primary uppercase tracking-[0.15em]"><?php echo e(__('footer.commitment')); ?></h4>
                <div class="w-8 h-0.5 bg-premium-brass mt-1.5 mb-5"></div>
                <ul class="flex flex-col gap-3">
                    <li class="font-body-sm text-body-sm text-secondary leading-relaxed flex items-start gap-2">
                        ...
                        <?php echo e(__('footer.commit_exclusive')); ?>

                    </li>
                    <li class="font-body-sm text-body-sm text-secondary leading-relaxed flex items-start gap-2">
                        <span class="material-symbols-outlined text-[14px] text-premium-brass shrink-0 mt-0.5">check</span>
                        <?php echo e(__('footer.commit_quality')); ?>

                    </li>
                    <li class="font-body-sm text-body-sm text-secondary leading-relaxed flex items-start gap-2">
                        <span class="material-symbols-outlined text-[14px] text-premium-brass shrink-0 mt-0.5">check</span>
                        <?php echo e(__('footer.commit_detail')); ?>

                    </li>
                    <li class="font-body-sm text-body-sm text-secondary leading-relaxed flex items-start gap-2">
                        <span class="material-symbols-outlined text-[14px] text-premium-brass shrink-0 mt-0.5">check</span>
                        <?php echo e(__('footer.commit_client')); ?>
            ...
            <div>
                <h4 class="font-label-lg text-label-lg text-primary uppercase tracking-[0.15em]"><?php echo e(__('footer.contact')); ?></h4>
                <div class="w-8 h-0.5 bg-premium-brass mt-1.5 mb-5"></div>
                <ul class="flex flex-col gap-2">
                    ...
                    <li>
                        <a href="https://www.instagram.com/cahayainteriorsejahtera_?igsh=d2tydTJoYWMwMXI4" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 font-body-sm text-body-sm text-secondary px-3 py-2 rounded-lg hover:bg-surface-container-lowest hover:shadow-level-1 transition-all duration-300 group">
                            ...
                            <?php echo e(__('footer.instagram')); ?>
                    ...
                    <li>
                        <a href="https://www.google.com/maps?q=Jl+Griya+Alam+Sentosa+No+101+Dusun+Pasir+Angin+Cileungsi+Bogor+Jawa+Barat" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 font-body-sm text-body-sm text-secondary px-3 py-2 rounded-lg hover:bg-surface-container-lowest hover:shadow-level-1 transition-all duration-300 group">
                            ...
                            <?php echo e(__('footer.google_maps')); ?>
        ...
        <div class="mt-10 pt-6 border-t border-outline-variant/30 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="flex flex-wrap justify-center gap-y-1 items-center">
                <a href="https://cahayainteriorsejahtera.com" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('footer.keyword_interior_bogor')); ?></a>
                <span class="text-premium-brass mx-2 hidden sm:inline">•</span>
                <a href="https://cahayainteriorsejahtera.com" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('footer.keyword_interior_jakarta')); ?></a>
                <span class="text-premium-brass mx-2 hidden sm:inline">•</span>
                <a href="https://cahayainteriorsejahtera.com" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('footer.keyword_interior_rumah')); ?></a>
                <span class="text-premium-brass mx-2 hidden sm:inline">•</span>
                <a href="https://cahayainteriorsejahtera.com" class="font-body-sm text-body-sm text-secondary hover:text-premium-brass transition-colors duration-300"><?php echo e(__('footer.keyword_interior_kantor')); ?></a>
            </div>
        </div>
    </div>
</footer>
<?php /**PATH C:\laragon\www\cis\resources\views/components/footer.blade.php ENDPATH**/ ?>