<?php $__env->startSection('title', 'Projects - Cahaya Interior Sejahtera'); ?>
<?php $__env->startSection('meta_description', 'Explore our portfolio of premium interior spaces and architectural achievements. Each project represents a synthesis of rigorous design methodology and masterful execution.'); ?>
...
<main class="pt-[140px] pb-section-gap">
    ...
    <div class="max-w-container-max mx-auto px-margin-desktop mb-gutter sticky top-[90px] z-40 bg-background/95 backdrop-blur-sm py-4">
        <ul class="flex flex-wrap gap-8 border-b border-outline-variant/50 pb-2">
            <li>
                <a href="<?php echo e(route('projects')); ?>" class="font-label-lg text-label-lg <?php echo e(!$category ? 'text-primary border-b border-primary' : 'text-secondary hover:text-primary'); ?> border-b pb-2 px-1 transition-all">All Projects</a>
            </li>
            <li>
                <a href="<?php echo e(route('projects', ['category' => 'Residential'])); ?>" class="font-label-lg text-label-lg <?php echo e($category === 'Residential' ? 'text-primary border-b border-primary' : 'text-secondary hover:text-primary'); ?> border-b pb-2 px-1 transition-all">Residential</a>
            </li>
            <li>
                <a href="<?php echo e(route('projects', ['category' => 'Commercial'])); ?>" class="font-label-lg text-label-lg <?php echo e($category === 'Commercial' ? 'text-primary border-b border-primary' : 'text-secondary hover:text-primary'); ?> border-b pb-2 px-1 transition-all">Commercial</a>
            </li>
            <li>
                <a href="<?php echo e(route('projects', ['category' => 'Office'])); ?>" class="font-label-lg text-label-lg <?php echo e($category === 'Office' ? 'text-primary border-b border-primary' : 'text-secondary hover:text-primary'); ?> border-b pb-2 px-1 transition-all">Office</a>
            </li>
            <li>
                <a href="<?php echo e(route('projects', ['category' => 'Hospitality'])); ?>" class="font-label-lg text-label-lg <?php echo e($category === 'Hospitality' ? 'text-primary border-b border-primary' : 'text-secondary hover:text-primary'); ?> border-b pb-2 px-1 transition-all">Hospitality</a>
            </li>
        </ul>
    </div>
    ...
    <section class="max-w-container-max mx-auto px-margin-desktop mb-section-gap">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center relative group cursor-pointer">
            ...
            <div class="md:col-span-8 rounded-card overflow-hidden shadow-level-1 relative h-[600px] w-full">
                <img alt="<?php echo e($featuredProject->title); ?>" class="absolute inset-0 w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700 ease-in-out" src="<?php echo e($featuredProject->featured_image); ?>">
            </div>
            ...
            <div class="md:col-span-5 md:-ml-24 md:mt-24 z-10 bg-surface-container-lowest p-10 rounded-card shadow-level-2 transform group-hover:-translate-y-2 transition-transform duration-500 border border-surface-variant/50">
                ...
                <h2 class="font-headline-lg text-headline-lg text-primary mb-4"><?php echo e($featuredProject->title); ?></h2>
                <p class="font-body-md text-body-md text-secondary mb-8 leading-relaxed"><?php echo e($featuredProject->short_description); ?></p>
            ...
            <article class="break-inside-avoid bg-surface-container-lowest rounded-card overflow-hidden shadow-level-1 hover:shadow-level-2 transition-shadow duration-300 group cursor-pointer border border-surface-variant/30">
                <a href="<?php echo e(route('projects.detail', ['slug' => $project->slug])); ?>">
                    <div class="relative overflow-hidden aspect-[4/5]">
                        <img alt="<?php echo e($project->title); ?>" class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" src="<?php echo e($project->featured_image); ?>">
                    </div>
                    <div class="p-6">
                        <h3 class="font-headline-sm text-headline-sm text-primary mb-2"><?php echo e($project->title); ?></h3>
