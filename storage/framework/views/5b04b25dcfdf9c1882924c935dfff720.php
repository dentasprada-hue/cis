...
<section class="relative h-[300px] sm:h-[420px] md:h-[560px] lg:h-[700px] overflow-hidden">
    ...
    <div class="relative z-10 h-full flex items-end px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto pb-8 md:pb-16">
        <div class="max-w-3xl">
            ...
            <h1 class="font-headline-xl text-[28px] sm:text-[40px] md:text-headline-xl text-white mb-3 md:mb-4 leading-tight"><?php echo e($project->title); ?></h1>
            <p class="font-body-lg text-[15px] md:text-body-lg text-white/90 max-w-2xl line-clamp-3 md:line-clamp-none"><?php echo e($project->short_description); ?></p>
        </div>
    </div>
</section>
...
<section class="py-12 md:py-section-gap bg-surface-container-lowest">
    <div class="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <h2 class="font-headline-lg text-[26px] md:text-headline-lg text-primary mb-8 md:mb-12"><?php echo e(__('projects.detail_gallery')); ?></h2>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cis\resources\views/pages/project-detail.blade.php ENDPATH**/ ?>